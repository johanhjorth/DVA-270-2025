...
\tikzstyle{io} = [trapezium, trapezium left angle=70, trapezium right angle=110, minimum width=1cm, minimum height=0.5cm, text centered, draw=black, fill=blue!30,node font=\scriptsize]
...
\IEEEauthorrefmark{2}studenttwo@student.mdh.se
}}
